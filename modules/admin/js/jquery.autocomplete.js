...
(function ($) {
    ...
    $.fn.autocomplete2 = function (options, args) {
        ...
        if (typeof options === 'string') {
            ...
            instance = new Autocomplete2(this.get(0) || $('<input />'), options);
        }
    ...
    Autocomplete2.prototype = {
        ...
        fixPosition: function () {
			...
			var w = this.el.width();
            $('#' + this.mainContainerId).css({ top: (offset.top + h) , left: offset.left, width:w }).find('.autocomplete').css({width:'auto'});
        ...
        onSelect: function (i) {
            ...
            me.el.val(me.getValue(sugestion)).change();
